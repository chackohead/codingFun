  ...
  <aside id="sidebar">
    ...
    <div id="sidebar-menu">
      <ul class="nav sidebar-nav">
        ...
        <li class="active"> <a class="accordion-toggle menu-open" href="#sideSeven"><span class="glyphicons glyphicons-warning_sign"></span><span class="sidebar-title">Utility Pages</span><span class="caret"></span></a>
          <ul id="sideSeven" class="nav sub-nav">
            ...
            <li class="active"><a href="blank.html"><span class="glyphicons glyphicons-unchecked"></span> Blank Page</a></li>
          </ul>
        </li>
      </ul>
    </div>
