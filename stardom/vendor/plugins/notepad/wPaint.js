/*! wPaint - v2.2.0 - 2013-10-23 */
!
function(a) {
    "use strict";

    function b(b, c) {
        this.$el = a(b), this.options = c, this.init = !1, this.menus = {
            primary: null,
            active: null,
            all: {}
        }, this.previousMode = null, this.width = this.$el.width(), this.height = this.$el.height(), this.ctxBgResize = !1, this.ctxResize = !1, this.generate(), this._init()
    }
    function c(a, b, c) {
        this.wPaint = a, this.options = c, this.name = b, this.type = a.menus.primary ? "secondary" : "primary", this.docked = !0, this.dockOffset = {
            left: 0,
            top: 0
        }, this.generate()
    }
    b.prototype = {
        generate: function() {
            function b(b) {
                var c = b ? b.capitalize() : "",
                    d = "canvas" + c,
                    e = "ctx" + c;
                return f[d] = document.createElement("canvas"), f[e] = f[d].getContext("2d"), f["$" + d] = a(f[d]), f["$" + d].attr("class", "wPaint-canvas" + (b ? "-" + b : "")).attr("width", f.width + "px").attr("height", f.height + "px").css({
                    position: "absolute",
                    left: 0,
                    top: 0
                }), f.$el.append(f["$" + d]), f["$" + d]
        ...
        resize: function() {
            var a = this.getBg(),
                b = this.getImage();
            this.width = this.$el.width(), this.height = this.$el.height(), this.canvasBg.width = this.width, this.canvasBg.height = this.height, this.canvas.width = this.width, this.canvas.height = this.height, this.ctxBgResize === !1 && (this.ctxBgResize = !0, this.setBg(a, !0)), this.ctxResize === !1 && (this.ctxResize = !0, this.setImage(b, "", !0))
        },
        setTheme: function(a) {
            var b, c;
        ...
        setImage: function(b, c, d) {
            function e() {
                var a = 1,
                    ...
                    k = g.width,
                    l = g.height;
                d || ((g.width > f.width || g.height > f.height) && (b = f.width / g.width, e = f.height / g.height, a = e > b ? b : e, k = g.width * a, l = g.height * a), i = (f.width - k) / 2, j = (f.height - l) / 2), h.clearRect(0, 0, f.width, f.height), h.drawImage(g, i, j, k, l), h || f._imageOnload(), f[c + "Resize"] = !1
            }
            if (!b) return !0;
            var f = this,
                g = null,
                h = "";
            c = "ctx" + (c || "").capitalize(), h = this[c], window.rgbHex(b) ? (h.clearRect(0, 0, this.width, this.height), h.fillStyle = b, h.rect(0, 0, this.width, this.height), h.fill()) : (g = new Image, g.src = b.toString(), a(g).load(e))
        },
        setBg: function(a, b) {
            return a ? (this.setImage(a, "bg", b), void 0) : !0
        },
        ...
        getImage: function(b) {
            var c = document.createElement("canvas"),
                d = c.getContext("2d");
            return b = b === !1 ? !1 : !0, a(c).css({
                display: "none",
                position: "absolute",
                left: 0,
                top: 0
            }).attr("width", this.width).attr("height", this.height), b && d.drawImage(this.canvasBg, 0, 0), d.drawImage(this.canvas, 0, 0), c.toDataURL()
        },
        getBg: function() {
        ...
        _createModal: function(b) {
            ...
            h.on("click", c), f.append(g.append(b)).append(h), this.$el.append(e).append(f), f.css({
                left: this.$el.outerWidth() / 2 - f.outerWidth(!0) / 2,
                top: this.$el.outerHeight() / 2 - f.outerHeight(!0) / 2
            }), f.fadeIn(500)
        },
        ...
        _fixMenus: function() {
            function b(b, d) {
                var e = a(d),
                    f = e.clone();
                f.appendTo(c.$el), f.outerHeight() === f.get(0).scrollHeight && e.css({
                    overflowY: "auto"
                }), f.remove()
            }
            var c = this,
        ...
        _drawShapeDown: function(a) {
            this.$canvasTemp.css({
                left: a.PageX,
                top: a.PageY
            }).attr("width", 0).attr("height", 0).show(), this.canvasTempLeftOriginal = a.pageX, this.canvasTempTopOriginal = a.pageY
        },
        _drawShapeMove: function(b, c) {
            var d = this.canvasTempLeftOriginal,
                e = this.canvasTempTopOriginal;
            c = c || 2, b.left = b.pageX < d ? b.pageX : d, b.top = b.pageY < e ? b.pageY : e, b.width = Math.abs(b.pageX - d), b.height = Math.abs(b.pageY - e), b.x = this.options.lineWidth / 2 * c, b.y = this.options.lineWidth / 2 * c, b.w = b.width - this.options.lineWidth * c, b.h = b.height - this.options.lineWidth * c, a(this.canvasTemp).css({
                left: b.left,
                top: b.top
            }).attr("width", b.width).attr("height", b.height), this.canvasTempLeftNew = b.left, this.canvasTempTopNew = b.top, c = c || 2, this.ctxTemp.fillStyle = this.options.fillStyle, this.ctxTemp.strokeStyle = this.options.strokeStyle, this.ctxTemp.lineWidth = this.options.lineWidth * c
        },
        ...
        setAlignment: function(a) {
            this.$menu.attr("class", this.$menu.attr("class").replace(/wPaint-menu-alignment-.+\s|wPaint-menu-alignment-.+$/, "")), this.$menu.addClass("wPaint-menu-alignment-" + a)
        },
        _createHandle: function() {
            ...
            return this.$menu.draggable({
                handle: f
            }), "secondary" === this.type && (this.$menu.draggable("option", "snap", this.wPaint.menus.primary.$menu), this.$menu.draggable("option", "start", b), this.$menu.draggable("option", "stop", c), this.$menu.draggable("option", "drag", d)), f.bindMobileEvents(), f
        },
        _createIconBase: function(b) {
            ...
            return g.attr("title", b.title).on("mousedown", a.proxy(this.wPaint._closeSelectBoxes, this.wPaint, b)).on("mouseenter", c).on("mouseleave", d).on("click", e), a.isNumeric(b.index) && h.css({
                backgroundImage: "url(" + b.img + ")",
                backgroundPosition: -i * b.index + "px 0px"
            }), g.append(h)
        },
        ...
        _createSelectBox: function(b) {
            ...
            var g = a('<div class="wPaint-menu-select-holder"></div>'),
                ...
                i = null;
            return g.on("mousedown mouseup", this.wPaint._stopPropagation).on("click", c).hide(), "horizontal" === this.options.alignment ? g.css({
                left: 0,
                top: b.children(".wPaint-menu-icon-img").realHeight("outer", !0, this.wPaint.$el)
            }) : g.css({
                left: b.children(".wPaint-menu-icon-img").realWidth("outer", !0, this.wPaint.$el),
                top: 0
            }), b.addClass("wPaint-menu-icon-select").append('<div class="wPaint-menu-icon-group-arrow"></div>').append(g.append(h)), b.hasClass("wPaint-menu-icon-group") ? b.on("mousedown", d).on("mouseup", e) : b.on("click", f), g
        },
        ...
        _createIconColorPicker: function(a) {
            ...
            return f.on("click", b).addClass("wPaint-menu-colorpicker").wColorPicker({
                mode: "click",
                generateButton: !1,
                dropperButton: !0,
                onSelect: c,
        ...
        _setPosition: function() {
            ...
            this.$menu.css({
                left: a.left + this.dockOffset.left,
                top: a.top + this.dockOffset.top
            })
        },
        _setIndex: function() {
        ...
        function e(b, e) {
            var f = a(e).data("wPaint"),
                g = null;
            f && (g = (d ? "set" : "get") + c.charAt(0).toUpperCase() + c.substring(1).toLowerCase(), f[c] ? f[c].apply(f, [d]) : d ? (f[g] && f[g].apply(f, [d]), f.options[c] && (f.options[c] = d)) : f[g] ? h.push(f[g].apply(f, [d])) : f.options[c] ? h.push(f.options[c]) : h.push(null))
        }
        function f(b, c) {
            return a.support.canvas ? (g(c), void 0) : (a(c).html("Browser does not support HTML5 canvas, please upgrade to a more modern browser."), !1)
        }
        function g(d) {
            var e = a.data(d, "wPaint");
            if (!e) {
                var f = a.extend(!0, {}, c);
                f.lineWidth = parseInt(f.lineWidth, 10), f.fontSize = parseInt(f.fontSize, 10), e = new b(d, f), a.data(d, "wPaint", e)
            }
            return e
        }
        if ("string" == typeof c) {
            var h = [],
                i = null;
            return i = this.each(e), 1 === h.length ? h[0] : h.length > 0 ? h : i
        }
        return c = a.extend({}, a.fn.wPaint.defaults, c), this.each(f)
        ...
        for (f in a) e(f)
    }, a.fn.wPaint.menus = {}, a.fn.wPaint.cursors = {}, a.fn.wPaint.defaults = {
        path: "/",
    ...
    a.fn.realWidth = function(b, c, d) {
        var e = null,
            f = null,
            g = null;
        return b = "inner" === b || "outer" === b ? b : "", g = "" === b ? "width" : b + "Width", c = c === !0 ? !0 : !1, f = a(this).clone().css({
            position: "absolute",
            left: -1e4
        }).appendTo(d || "body"), e = c ? f[g](c) : f[g](), f.remove(), e
    }, a.fn.realHeight = function(b, c, d) {
        var e = null,
            f = null,
            g = null;
        return b = "inner" === b || "outer" === b ? b : "", g = "" === b ? "height" : b + "Height", c = c === !0 ? !0 : !1, f = a(this).clone().css({
            position: "absolute",
            left: -1e4
        }).appendTo(d || "body"), e = c ? f[g](c) : f[g](), f.remove(), e
